...
import { execute, logActivity, query } from '../models/database.js';
  ...
  async (req, res) => {
    ...
    try {
      ...
      const DEMO_USER_PASSWORD =
        process.env.DEMO_USER_PASSWORD || 'DemoUser' + Date.now().toString(36);
      ...
      const clients = [
        ...
        },
        {
          ...
          notes: 'Organic farm with e-commerce needs',
        },
        {
          name: 'Urban Design Studio',
          email: 'studio@urbandesign.co',
          ...
          notes: 'Architecture and design firm',
        },
        {
          ...
          phone: '555-0105',
          website: 'https://sjconsulting.com',
          address: '654 Professional Dr, Denver, CO 80202',
          status: 'active',
          monthly_retainer: 1000,
          notes: 'Business consultant, needs portfolio site',
        },
        {
          ...
          address: '987 Education Way, Chicago, IL 60601',
          status: 'active',
          monthly_retainer: 3000,
          notes: 'Private school, LMS integration',
        },
        {
          name: 'Pacific Marine Services',
          email: 'ops@pacificmarine.com',
          company: 'Pacific Marine Services',
          phone: '555-0107',
          website: 'https://pacificmarine.com',
          address: '159 Harbor View, Seattle, WA 98101',
          status: 'active',
          monthly_retainer: 4000,
          notes: 'Marine logistics company',
        },
        {
          name: 'Old Town Bakery',
          email: 'hello@oldtownbakery.com',
          company: 'Old Town Bakery',
          phone: '555-0108',
          website: null,
          address: '753 Main Street, Boston, MA 02101',
          status: 'inactive',
          monthly_retainer: null,
          notes: 'Paused services, seasonal business',
        },
        {
          name: 'NextGen Fitness',
          email: 'team@nextgenfitness.com',
          company: 'NextGen Fitness',
          phone: '555-0109',
          website: 'https://nextgenfitness.com',
          address: '852 Wellness Blvd, Miami, FL 33101',
          status: 'active',
          monthly_retainer: 1800,
          notes: 'Gym chain with booking system',
        },
        {
          name: 'Mountain View Properties',
          email: 'sales@mvproperties.com',
          company: 'Mountain View Properties',
          phone: '555-0110',
          website: 'https://mvproperties.com',
          address: '951 Real Estate Row, Phoenix, AZ 85001',
          status: 'lead',
          monthly_retainer: null,
          notes: 'Potential client - real estate CRM needed',
        },
      ];
      ...
      const clientUsers = [
        ...
        {
          username: 'manager_fitness',
          email: 'manager@nextgenfitness.com',
      ...
      for (const user of clientUsers) {
        try {
          execute(
            `INSERT INTO users (username, email, password, role, client_id, is_demo) VALUES (?, ?, ?, 'user', ?, 1)`,
      ...
      const projects = [
        {
          ...
          description: 'Complete overhaul of main website with modern design',
          status: 'in-progress',
          priority: 'high',
          budget: 25000,
          hours_estimated: 200,
          start_date: "date('now', '-30 days')",
          end_date: "date('now', '+60 days')",
        },
        {
          client_id: clientIds[0],
          title: 'Employee Portal Development',
          description: 'Internal portal for HR and employee management',
          status: 'planning',
          priority: 'medium',
          budget: 15000,
          hours_estimated: 120,
          start_date: "date('now', '+30 days')",
          end_date: "date('now', '+120 days')",
        },
        {
          ...
          end_date: "date('now', '-30 days')",
          completion_date: "date('now', '-32 days')",
        },
        {
          client_id: clientIds[1],
          title: 'Dashboard UI/UX',
          description: 'User dashboard design and implementation',
          status: 'in-progress',
          priority: 'high',
          budget: 12000,
          hours_estimated: 100,
          hours_actual: 45,
          start_date: "date('now', '-20 days')",
          end_date: "date('now', '+40 days')",
        },
        {
          client_id: clientIds[2],
          title: 'E-commerce Store',
          description: 'Online store for farm products with delivery scheduling',
          status: 'in-progress',
          priority: 'medium',
          budget: 8000,
          hours_estimated: 80,
          hours_actual: 30,
          start_date: "date('now', '-15 days')",
          end_date: "date('now', '+45 days')",
        },
        {
          client_id: clientIds[3],
          title: 'Portfolio Website',
          description: 'Showcase portfolio with project galleries',
          status: 'completed',
          priority: 'medium',
          budget: 6000,
          hours_estimated: 50,
          ...
          completion_date: "date('now', '-45 days')",
        },
        {
          client_id: clientIds[4],
          title: 'Consulting Services Site',
          description: 'Professional services website with booking',
          status: 'review',
          priority: 'medium',
          budget: 4000,
          hours_estimated: 35,
          hours_actual: 33,
          start_date: "date('now', '-25 days')",
          end_date: "date('now', '+5 days')",
        },
        {
          client_id: clientIds[5],
          title: 'School Website + LMS',
          description: 'Main website with integrated learning management',
          status: 'in-progress',
          priority: 'high',
          budget: 35000,
          hours_estimated: 300,
          hours_actual: 120,
          start_date: "date('now', '-45 days')",
          end_date: "date('now', '+90 days')",
        },
        {
          client_id: clientIds[6],
          title: 'Fleet Tracking Dashboard',
          description: 'Real-time vessel tracking and management',
          status: 'planning',
          priority: 'high',
          budget: 20000,
          hours_estimated: 180,
        ...
        },
        {
          ...
          description: 'Mobile app promotional website',
          status: 'in-progress',
          priority: 'medium',
          budget: 3500,
          hours_estimated: 30,
          ...
          end_date: "date('now', '+20 days')",
        },
        {
          client_id: clientIds[8],
          title: 'Member Portal',
          description: 'Member dashboard with class booking',
          status: 'on-hold',
          priority: 'low',
          budget: 10000,
          hours_estimated: 90,
          start_date: "date('now', '+60 days')",
          end_date: "date('now', '+150 days')",
        },
      ];
      ...
      const taskTemplates = [
        {
          title: 'Initial Planning & Discovery',
          status: 'completed',
          priority: 'high',
          hours_estimated: 8,
        },
          ...
          try {
            execute(
              ...
              [
                projectIds[i],
                template.title,
                `Task for project ${i + 1}`,
                template.status,
                template.priority,
                template.hours_estimated,
                (j + 1) * 7,
              ]
            );
            taskCount++;
      ...
      const messageTemplates = [
        {
          ...
          content: "Hi! Excited to get started on your project. Here's what we'll need to begin...",
          direction: 'outbound',
        },
        {
          subject: 'Re: Project Kickoff',
          content:
            "Thanks for reaching out! We're looking forward to working with you. Here's the information you requested...",
          direction: 'inbound',
        },
        {
          subject: 'Weekly Update',
          content:
            "Here's your weekly project progress update. We've completed the following milestones...",
          direction: 'outbound',
        },
        {
          subject: 'Design Approval',
          content: 'Please review the attached mockups and let us know your feedback.',
          direction: 'outbound',
        },
        {
          subject: 'Re: Design Approval',
          content: 'The designs look great! Just a few minor tweaks needed...',
          direction: 'inbound',
        },
        {
          subject: 'Invoice #1001',
          content: "Please find attached your invoice for this month's work.",
          direction: 'outbound',
        },
        {
          subject: 'Meeting Reminder',
          content: 'Just a reminder about our call tomorrow at 2 PM.',
          direction: 'outbound',
        },
        {
          subject: 'Feature Request',
          content: "We'd like to add a new feature to the project...",
          direction: 'inbound',
        },
      ];
          ...
          try {
            execute(
              ...
              [
                ...
                template.subject,
                template.content,
                j * 24 + Math.floor(Math.random() * 12),
              ]
            );
            messageCount++;
          } catch (e) {
      ...
      const contactSubmissions = [
        {
          ...
          message: 'We need a new website for our startup. Can you provide a quote?',
        },
        {
          name: 'Emily Chen',
          ...
          message: 'Looking for someone to build our design portfolio. Love your work!',
        },
        {
          name: 'Robert Brown',
          email: 'robert@lawfirm.com',
          company: 'Brown & Associates',
          subject: 'Law Firm Website',
          message: 'Our law firm needs a professional website with client portal.',
        },
        {
          name: 'Maria Garcia',
          ...
          message: 'We need a website with online ordering capabilities.',
        },
        {
          name: 'David Lee',
          ...
          message: 'Looking for a property listing website with search functionality.',
        },
        {
          name: 'Jennifer Smith',
          email: 'jen@nonprofit.org',
          company: 'Helping Hands',
          subject: 'Non-profit Website',
          message: 'We need a website with donation functionality for our charity.',
        },
        {
          ...
          message: 'Need help building an e-commerce platform with inventory management.',
        },
        {
          name: 'Amanda White',
          email: 'amanda@fitness.com',
          company: null,
          subject: 'Personal Training Site',
          message: "I'm a personal trainer looking for a website to book clients.",
        },
      ];
      ...
      const segments = [
        { name: 'All Clients', description: 'All clients in the system', filter_rules: '{}' },
        {
          ...
          description: 'Clients with active monthly retainers',
          filter_rules: '{"status":"active","has_retainer":true}',
        },
        {
          name: 'High Value',
          description: 'Clients with retainers over $2000/month',
          filter_rules: '{"min_retainer":2000}',
        },
        {
          name: 'Inactive',
          description: 'Clients marked as inactive',
          filter_rules: '{"status":"inactive"}',
        },
        {
          name: 'New Leads',
          description: 'Potential clients (leads)',
          filter_rules: '{"status":"lead"}',
        },
        {
          name: 'Enterprise',
          description: 'Enterprise-level clients',
          filter_rules: '{"min_retainer":4000}',
        },
      ];
      ...
      for (const seg of segments) {
        try {
          execute(
            `INSERT INTO segments (name, description, filter_rules, created_by, is_demo) VALUES (?, ?, ?, 1, 1)`,
      ...
      const campaigns = [
        ...
        },
        {
          ...
          subject: 'February Updates from SFG',
          content: "<h1>Monthly Newsletter</h1><p>Here's what's new...</p>",
          status: 'sent',
          segment_id: 2,
        },
        {
          ...
          content: '<h1>Special Offer</h1><p>Upgrade your plan today!</p>',
          status: 'draft',
          segment_id: 3,
        },
        {
          ...
          subject: 'We Miss You!',
          content: "<h1>It's Been a While</h1><p>Let's catch up...</p>",
          status: 'scheduled',
          segment_id: 4,
        },
        {
          ...
          content: "<h1>New Features</h1><p>Check out what's new...</p>",
          status: 'draft',
          segment_id: 1,
        },
      ];
      ...
      const emailTemplates = [
        {
          name: 'Welcome Email',
          subject: 'Welcome to Structured For Growth!',
          content: "<h1>Welcome, {{clientName}}!</h1><p>We're excited to work with you.</p>",
          category: 'onboarding',
        },
        {
          name: 'Project Kickoff',
          subject: "Let's Get Started - {{projectName}}",
          content:
            "<h1>Project Kickoff</h1><p>Hi {{clientName}}, we're ready to begin your project.</p>",
          category: 'projects',
        },
        {
          name: 'Weekly Update',
          subject: 'Weekly Progress Update',
          content: "<h1>Progress Update</h1><p>Here's what we accomplished this week...</p>",
          category: 'updates',
        },
        {
          name: 'Invoice',
          subject: 'Invoice #{{invoiceNumber}}',
          content: '<h1>Invoice</h1><p>Please find your invoice attached.</p>',
          category: 'billing',
        },
        {
          name: 'Project Complete',
          subject: 'Your Project is Complete! 🎉',
          content: '<h1>Congratulations!</h1><p>Your project {{projectName}} is now live.</p>',
          category: 'milestone',
        },
        {
          name: 'Meeting Request',
          subject: 'Meeting Request - {{topic}}',
          content: "<h1>Let's Meet</h1><p>I'd like to schedule a meeting to discuss {{topic}}.</p>",
          category: 'meetings',
        },
        {
          name: 'Thank You',
        ...
        },
        {
          ...
          content: "<h1>Feedback</h1><p>We'd love to hear about your experience.</p>",
          category: 'feedback',
        },
        {
          name: 'Holiday Greeting',
          subject: 'Happy Holidays from SFG!',
          content: '<h1>Happy Holidays!</h1><p>Wishing you a wonderful holiday season.</p>',
          category: 'seasonal',
        },
        {
          name: 'Renewal Reminder',
          subject: 'Your Service is Up for Renewal',
          content: '<h1>Renewal Time</h1><p>Your service will renew on {{renewalDate}}.</p>',
          category: 'billing',
        },
      ];
      ...
      for (const tmpl of emailTemplates) {
        try {
          execute(
            `INSERT INTO email_templates (name, subject, content, category, created_by, is_demo) VALUES (?, ?, ?, ?, 1, 1)`,
      ...
      const activities = [
        ...
        },
        {
          ...
          entity_type: 'project',
          details: 'Created project: Corporate Website Redesign',
        },
        {
        ...
        { action: 'SEND_MESSAGE', entity_type: 'message', details: 'Sent message to client' },
        {
          ...
          details: 'Created campaign: Welcome Series',
        },
      ...
      logActivity(
        ...
        null,
        null,
        JSON.stringify(results.created)
      );
      ...
      res
        .status(500)
        .json({ success: false, message: 'Failed to generate demo data: ' + error.message });
    }
  }
);
...
router.get('/stats', authenticateToken, (req, res) => {
  try {
    ...
    const demo = {
      ...
      timeEntries:
        query('SELECT COUNT(*) as count FROM time_entries WHERE is_demo = 1')[0]?.count || 0,
      ...
      contactSubmissions:
        query('SELECT COUNT(*) as count FROM contact_submissions WHERE is_demo = 1')[0]?.count || 0,
      segments: query('SELECT COUNT(*) as count FROM segments WHERE is_demo = 1')[0]?.count || 0,
      emailTemplates:
        query('SELECT COUNT(*) as count FROM email_templates WHERE is_demo = 1')[0]?.count || 0,
      activityLog:
        query('SELECT COUNT(*) as count FROM activity_log WHERE is_demo = 1')[0]?.count || 0,
    };
...
router.post(
  ...
  authenticateToken,
  requireRole('admin'),
  [body('clearAll').optional().isBoolean().withMessage('clearAll must be a boolean')],
  (req, res) => {
    const valErr = handleValidation(req, res);
    if (valErr) {
      return;
    ...
    try {
      ...
      triggerAutoBackup(
        'DEMO_DATA_CLEAR',
        req.user.userId,
        clearAll ? 'Before clearing ALL data' : 'Before clearing demo data'
      );
