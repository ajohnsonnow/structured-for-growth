...
function displayClientInfo() {
  ...
  document.getElementById('infoRetainer').textContent = retainer
    ? formatCurrency(retainer) + '/month'
    : 'No retainer';
}
      ...
      (project) => `
        <div class="project-card">
            <div class="project-header">
                ...
                <span class="badge badge-${getStatusBadge(project.status)}">${escapeHTML(formatStatus(project.status))}</span>
            </div>
      ...
      (estimate) => `
        <div class="estimate-card">
            <div class="estimate-header">
                ...
                <span class="badge badge-${estimate.status === 'pending' ? 'warning' : 'success'}">${escapeHTML(estimate.status)}</span>
            </div>
            <p class="estimate-description">${escapeHTML(estimate.description || '')}</p>
