...
_Generated from axe-core automated audit results (`docs/WCAG-AUDIT-RESULTS.md`) and manual code review. Re-run `npm run report:wcag` to regenerate underlying audit data._
